...
CREATE TABLE ncp_buffer AS SELECT a.name, a.boundary, ST_Buffer( ST_Transform(a.the_geom, utmzone(ST_Centroid(a.the_geom))), 20) AS geom FROM nature_conservation_polygon a;
